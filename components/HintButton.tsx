  ...
  return (
    <>
      <motion.button
        ...
        className={`px-2 sm:px-4 py-2 rounded-xl font-medium transition-colors flex items-center justify-center gap-1.5 sm:gap-2 ${
          hasHint
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <span className="hidden sm:inline text-sm">{hasHint ? 'Hint' : 'Unlock Hint'}</span>
          </>
        )}
      </motion.button>
