  ...
  return (
    <>
      <motion.button
        ...
        className={`px-3 sm:px-4 py-2 rounded-xl font-medium transition-colors flex items-center gap-1.5 sm:gap-2 ${
          hasHint
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <span className="text-xs sm:text-sm">{hasHint ? 'Hint' : 'Unlock Hint'}</span>
          </>
        )}
      </motion.button>
